        ...
        <div className="hero-section">
          <div className="hero-content">
            ...
            >
              ...
              >
                <span className="typing-text">웹 개발자</span>
              ...
              >
                사용자 경험을 중시하며, 창의적이고 직관적인 웹 애플리케이션을 개발합니다.
                React, JavaScript를 기반으로 현대적인 웹 솔루션을 제공합니다.
              </motion.p>
              <motion.div 
            ...
            >
              ...
              >
                <div className="project-image">
                  <img 
                    src={project.id === 1 ? kakaoImage : project.id === 2 ? heukbeakImage : project.id === 3 ? bgp1Image : project.id === 4 ? radio1Image : project.id === 5 ? chatbot1Image : kakaoImage} 
                    alt={project.id === 1 ? "카카오톡 UI 클론 프로젝트" : project.id === 2 ? "NHN 아카데미 흑백문고 프로젝트" : project.id === 3 ? "LLM 기반 BGP 분석 챗봇 프로젝트" : project.id === 4 ? "라디오 다시듣기 사이트 프로젝트" : project.id === 5 ? "MCP/RAG 기반 챗봇 모음 사이트 프로젝트" : "프로젝트"} 
                  ...
                  <div className="project-overlay">
                    <div className="project-links">
                      ...
                      {(project.id === 1 || project.id === 4 || project.id === 5) && project.link && (
                        <motion.a 
                          href={project.link} 
                          target="_blank" 
                          rel="noopener noreferrer" 
            ...
            >
              ...
              <div className="modal-content">
                <div className="modal-image">
                  <img 
                    src={selectedProject.id === 1 ? kakaoImage : selectedProject.id === 2 ? heukbeakImage : selectedProject.id === 3 ? bgp1Image : selectedProject.id === 4 ? radio1Image : selectedProject.id === 5 ? chatbot1Image : kakaoImage} 
                    alt={selectedProject.id === 1 ? "카카오톡 UI 클론 프로젝트" : selectedProject.id === 2 ? "NHN 아카데미 흑백문고 프로젝트" : selectedProject.id === 3 ? "LLM 기반 BGP 분석 챗봇 프로젝트" : selectedProject.id === 4 ? "라디오 다시듣기 사이트 프로젝트" : selectedProject.id === 5 ? "MCP/RAG 기반 챗봇 모음 사이트 프로젝트" : "프로젝트"} 
                    ...
                    <>
                      <div className="project-summary">
                        ...
                        <ul>
                          ...
                          <li><strong>개발 기간:</strong> 2023.07 - 약 2주</li>
                    ...
                    <>
                      <div className="project-summary">
                        ...
                        <ul>
                          ...
                          <li><strong>개발 기간: </strong> 2024.07 - 2024.12 (약 6개월)</li>
                    ...
                    <>
                      <div className="project-summary">
                        ...
                        <ul>
                          ...
                          <li><strong>개발 기간:</strong> 2024.03 - 현재 (졸업프로젝트)</li>
                    ...
                    <>
                      <div className="project-summary">
                        ...
                        <ul>
                          ...
                          <li><strong>개발 기간:</strong> 2024.03 - 2024.08 (약 5개월)</li>
                    ...
                    <>
                      <div className="project-summary">
                        ...
                        <ul>
                          ...
                          <li><strong>개발 기간:</strong> 2024.05 - 2024.09 (약 4개월)</li>
                          <li><strong>참여 인원:</strong> 팀 프로젝트 (3명)</li>
...
- API Docs: Swagger (https://llm-contest.onrender.com/docs)`}
                  ...
                  <div className="modal-links">
                    ...
                    {(selectedProject.id === 1 || selectedProject.id === 4 || selectedProject.id === 5) && selectedProject.link && (
                      <a 
