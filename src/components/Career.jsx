...
const careerItems = [
    ...
    {
        title: "충남대학교 데이터 네트워크 연구실",
        period: "2025.03 - 2025.08",
        role: "학부연구생",
        description: "컴퓨터융합학부 데이터 네트워크 연구실에서 학부연구생으로 활동했습니다. AI 기반 라디오 방송 디지털 아카이브 플랫폼을 개발하며, OpenAI Whisper와 GPT를 활용한 음성 인식 및 콘텐츠 자동 조각화 시스템을 연구·구현했습니다."
    },
    {
        title: "NHN 백엔드 아카데미",
    ...
    },
    {
        ...
        role: "학사 졸업",
        description: "컴퓨터공학 전반을 학습하며 자료구조, 알고리즘, 운영체제, 네트워크, 데이터베이스 등 전공 과목을 이수했습니다. 다수의 팀 프로젝트를 통해 협업 경험을 쌓고, 오픈소스 기여 및 논문 작성에도 참여하며 소프트웨어 개발의 기초와 연구 역량을 함께 다졌습니다."
    },
];
